...
import MobileScrollFAB from "@/components/movies/MobileScrollFAB";
...
export default function MovieDetailPage() {
  ...
  return (
    <section className="relative min-h-screen text-white">
      ...
      {/* Backdrop z parallax (fade-in + maska) */}
      {movie.backdrop_path ? (
        <div className="relative w-full h-[400px] sm:h-[800px] overflow-hidden">
          ...
          >
            ...
            {movie.tagline && (
              <p className="px-8 md:px-10 mx-auto max-w-6xl text-lg italic">
                {movie.tagline}
              </p>
            )}
          </motion.div>
