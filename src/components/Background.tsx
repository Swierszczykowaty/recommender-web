...
'/recommender': [
  'rgba(88, 28, 135, 0.4)',   // głęboki fiolet (purple-900)
  'rgba(147, 51, 234, 0.3)',  // klasyczny fiolet (purple-600)
  'rgba(236, 72, 153, 0.2)',  // pink-500 z niższą alfą
  'rgba(244, 114, 182, 0.2)', // pink-300, bardzo subtelny
  'rgba(109, 40, 217, 0.3)',  // purple-700
],

  // /about – stonowana zieleń / teal
  '/about': [
    'rgba(22, 163, 74, 0.3)',   // green-700
