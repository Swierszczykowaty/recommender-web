...
>
  ...
  {open && (
    <div className="absolute top-full mt-2 right-0 md:left-0 w-40 md:w-60 bg-gray-900/30 backdrop-blur-xl rounded-xl shadow-lg p-2 z-50 border border-white/30">
      {sortOptions.map((opt) => (
        <button
          key={opt.value}
