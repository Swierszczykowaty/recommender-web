...
import Icon from "@/components/global/Icon"; // Zakładam, że ścieżka się zgadza
...
interface HeroCardProps {
  ...
  description: string;
  buttonText: string;
  href?: string; // Dodajemy opcjonalny link
  onButtonClick?: () => void; // Nadal można obsłużyć kliknięcie po swojemu
}
...
const HeroCard: React.FC<HeroCardProps> = ({
  ...
  // Renderujemy button jako <a> jeśli href, w innym przypadku normalny <button>
