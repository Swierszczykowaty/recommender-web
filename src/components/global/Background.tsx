...
export default function AnimatedBackground({
  ...
  return (
    <div className="fixed inset-0 -z-10 pointer-events-none">
      <AnimatedBlob
        className="top-0 left-[-10%] w-[1000px] h-[1000px]"
        color={colors[0]}
        x={40}
        y={-80}
        duration={10}
      />
      <AnimatedBlob
        className="top-[30%] right-0 w-[900px] h-[900px]"
        color={colors[1]}
        x={-40}
        y={60}
        duration={8}
      />
      <AnimatedBlob
        className="bottom-60 left-[40%] w-[700px] h-[700px]"
        color={colors[2]}
        x={40}
        y={-60}
        duration={12}
      />
      <AnimatedBlob
        className="bottom-[-10%] left-[20%] w-[600px] h-[600px]"
        color={colors[3]}
        x={80}
        y={-80}
        duration={14}
      />
      <AnimatedBlob
        className="top-[-10%] left-[70%] w-[500px] h-[500px]"
        color={colors[4]}
        x={-60}
        y={-60}
        duration={10}
