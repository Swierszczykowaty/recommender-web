    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 md:px-8 py-16">
      <Container>
        <div className="flex flex-col items-center justify-center relative z-10 w-full text-center">
          ...
          >
            <Title subtitle="Wybierz, co Cię interesuje">Rekomendacje filmowe</Title>
          </motion.div>
          ...
          >
            ...
            >
              <div>
                <span className="material-icons text-6xl md-60 text-white/80 mb-6">insights</span>
            ...
            >
              <div>
                <span className="material-icons text-6xl md-60 text-white/80 mb-6">storage</span>
